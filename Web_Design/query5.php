...
if(($count==2&&$itc<=98)||($count==1&&$itc<=98))
{
	$chap=mysql_fetch_array(mysql_query("select chapter_name,chapter_no from chapter where chapter_no=$itc "));
		...
		while($row1=mysql_fetch_array($query1))
		{
			...
			echo"<br>";
			$hs4=$row1['hs4_no'];
			$query2=mysql_query("select hs6_no, hs6_des from hs6_new where hs4_no=$hs4 ");
			...
			while($row2=mysql_fetch_array($query2))
			{
				...
				echo"<th width=400>Item Description</th>";
				echo"<th width=200>Policy</th>";
				echo"<th width=300>Condition</th>";
...
else if(($count==5&&$itc<=91099)||($count==6&&$itc<=980590))
{
	...
	echo "Subheading"."    &nbsp; ".$row1['hs4_no']."    &nbsp; "."   &nbsp;"."<br>".$row1['hs4_des'];
	echo"<br>";
	$query2=mysql_query("select hs6_no,hs6_des from hs6_new where hs6_no=$itc ");
...
else if(($count==7&&$itc<=9109990)||($count==8&&$itc<=98059000))
{
	...
	echo"<br>";
	$hs6=(int)($itc/100);
	$query2=mysql_query("select hs6_no,hs6_des from hs6_new where hs6_no=$hs6 ");
	$row2=mysql_fetch_array($query2);
