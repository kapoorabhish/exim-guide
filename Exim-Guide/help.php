 ...
 <!--============================== content =================================-->
    ...
    <div class="container">
        ...
        <ul class="thumbnails thumbnails-1 list-services">
              <li class="span4"><a href="weblink.php" >
            <div class="thumbnail thumbnail-1"> <img  src="imgs/links.jpg" alt="">
                  <section><h5> WEB LINKS</h5>
                
              </section>
                </div></a>
          </li>
              <li class="span4"> <a href="asso.php">
            <div class="thumbnail thumbnail-1"> <img  src="imgs/asso.jpg" alt="">
                  <section><h5> TRADE ASSOCIATIONS</h5>
